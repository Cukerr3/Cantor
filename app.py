...
app_info = {
    'db_file' : 'C:/Users/cuker/OneDrive/Dokumenty/Projekt/data/cantor.db'
}

app = Flask(__name__)

app.config['SECRET_KEY'] = 'TAJNYnapis'
...
class CantorOffer:
    ...
    def load_offer(self):
        self.currenties.append(Currency('USD', 'Dollar', 'us.png'))
        self.currenties.append(Currency('EUR', 'Euro', 'eur.png'))
        self.currenties.append(Currency('JPY', 'Yen', 'jp.png'))
        self.currenties.append(Currency('GBP', 'Pound', 'eng.png'))
        '''self.danied_codes.append('USD')'''

    def get_by_code(self, code):
        for currency in self.currenties:
            if currency.code == code:
                return currency
        return Currency('unknown', 'unknown', 'eng.png')
